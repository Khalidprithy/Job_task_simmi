            ...
            <div class="container mx-auto px-6 pt-6">
              ...
              "
                            ...
                            <div class="md:mr-auto mb-6">
                                <button type="submit" class="inline-block px-6 py-2 border-2 border-white text-white font-medium text-xs leading-tight uppercase rounded hover:bg-secondary focus:outline-none focus:ring-0 transition duration-150 ease-in-out">
                                    Subscribe
                                </button>
                            </div>
                        </div>
                ...
                <div class="grid lg:grid-cols-3 md:grid-cols-1">
                    ...
                    <div>
                        <div className='flex items-center justify-center gap-2 mb-4'>
                            <img className='w-12' src="https://simmifoundation.org/home/images/logo.png" alt="" />
                            <img className='w-12' src="https://simmifoundation.org/home/images/NITI-Aayog-logo.png" alt="" />
                        </div>
                        <p className='mb-2'>Our Registration number : 085953/2020</p>
                    ...
                    <div class="mb-6 w-8/12 mx-auto">
                        <h5 class="uppercase font-semibold border-b w-8/12 mb-2.5 mx-auto">Have Questions?</h5>
